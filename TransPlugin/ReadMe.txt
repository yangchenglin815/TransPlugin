========================================================================
    活动模板库 : TransPlugin 项目概述
========================================================================

应用程序向导已为您创建了此 TransPlugin 项目，作为编写动态链接库 (DLL) 
的起点。
...
TransPlugin.idl
    ...
    此文件将由 MIDL 编译器处理以生成：
        C++ 接口定义和 GUID 声明		(TransPlugin.h)
        GUID 定义			(TransPlugin_i.c)
        类型库				(TransPlugin.tlb)
        封送处理代码			(TransPlugin_p.c 和 
                                           dlldata.c）

TransPlugin.h
    此文件包含 TransPlugin.idl 中定义的项目的 C++ 接口定义
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 TransPlugin.pch 的预编译头 (PCH) 文件和
